...
const FormRenewal = ({ open, handleClose }) => {
    ...
    return (
        ...
        >
            ...
            <DialogContent sx={{ padding: "30px", minHeight: "85vh", display: 'flex', flexDirection: 'column', overflowY: "auto" }}>
                <FormService isSubscription handleClose={handleClose && handleClose} />
